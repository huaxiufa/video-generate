...
"segments":[{"segment_no":1,"title":"剧情片段标题","summary":"这个约12秒片段发生了什么","shot_ids":[1,2],"target_duration":12}],
"warnings":[]}
...
8. 每个剧情片段目标约12秒。优先在自然的动作/对白边界切段；允许 8-16 秒，但尽量接近12秒。
...
def analyze_script(script, api_key="", base_url="https://apihub.agnes-ai.com/v1", model="agnes-3.0-flash"):
    ...
    payload={"model":model,"messages":[{"role":"system","content":SYSTEM_PROMPT},{"role":"user","content":"请分析下面这份完整剧本并生成分镜与约12秒剧情片段：\n\n"+script}],"temperature":0.2}
